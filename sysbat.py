...
def sys_pwseq():
    try:
        ...
        print("FATAL ERROR: [F402] Necessary components/files are absent. Please contact system administrators immediately.")
        input("Press ENTER to initiate system restart.")
        return
    sys_pass = True
    global sys_on
...
def enc_seq():
    def encHelp(parameter):
        if parameter == "general":
            ...
            S2TE: "/:>:L:" ---(EHK:4b083a01 ≥790 Hz, ~1.8W)---> RCVR >(AT)> "AXE" 
            """)
...
while breakall == False:
    ...
    Main Processor: Oriental XVCe 80084 Model 5 @ 1.2GHz, 2 Cores
    Architecture: O-ZONE 5.0 Family Architecture
    Graphics Processor: ERROR 330: Not Found
    """)
    time.sleep(1)
    print("""
    Detecting Memory.....
    ...
    time.sleep(2)
    print("""
    Memory Testing: 634766KB  ...OK
    Memory Frequency: 1300MHz
    """)
    time.sleep(1)
    print("""
    ...
    time.sleep(2)
    print("""
    HDD0 Testing: 2048000KB  ...OK
    HDD0 Read Speed: 163840KB/s
    HDD0 Write Speed: 133120KB/s
    """)
    time.sleep(1)
    print("Initiate operating system startup.....")
    time.sleep(2)
    clear_terminal()
    time.sleep(1)
